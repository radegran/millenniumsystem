...
var Bubble = function (x, y, r, fillColor) {
    var shape = new paper.Path.Circle(new paper.Point(x, y), r);
...
var debug = function (id, p, r, fillColor) {
    ...
    if (!debug.elem[id]) {
        debug.elem[id] = Bubble(p.x, p.y, r, fillColor);
    }
...
var Game = function (canvas) {
    ...
    var playerBall = Bubble(boardLeft + ballsPerRow * radius, canvasHeight - 3 * radius, radius);
    var shooting = false;
                ...
                for (var j = hexX - 1; j <= hexX + 1; j++) {
                    ...
                    if (bubble) {
                        ...
                        if (dist < 2 * radius * 0.9) {
                            ...
                            playerBall = Bubble(boardLeft + ballsPerRow * radius, canvasHeight - 3 * radius, radius);
